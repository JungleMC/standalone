...
func (c *Client) onClientConnect() {
	c.Protocol = protocol.ProtocolHandshake
	c.ExpectedVerifyToken = make([]byte, 4)
	c.Profile = auth.Profile{}
	rand.Read(c.ExpectedVerifyToken)
}
